...
public:
	...
	virtual StudioHDR* GetStudioHdr(MDLHandle_t hModel) = 0;
	virtual StudioHWData* GetHardwareData(MDLHandle_t hModel) = 0;
	...
	virtual void* GetVirtualModelFast(const StudioHDR* pStudioHdr, MDLHandle_t hModel) = 0;
	...
	virtual StudioHDR* LockStudioHdr(MDLHandle_t hModel) = 0;
