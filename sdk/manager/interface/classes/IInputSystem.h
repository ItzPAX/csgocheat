...
public:
	...
	bool IsButtonDown(ButtonCode code) {
		using original_fn = bool(__thiscall*)(void*, ButtonCode);
		return (*(original_fn**)this)[15](this, code);
	}

	int GetAnalogVal(AnalogCode code) {
		using original_fn = int(__thiscall*)(void*, AnalogCode);
		return (*(original_fn**)this)[18](this, code);

	}

	int GetAnalogDelta(AnalogCode code) {
		using original_fn = int(__thiscall*)(void*, AnalogCode);
