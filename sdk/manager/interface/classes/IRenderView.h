...
public:
    ...
    virtual float*    GetLightAtPoint(Vec3D& vecPosition) = 0;
    ...
    virtual void      DrawBrushModelShadowDepth(Entity* pEntity, Model* pModel, const Vec3D& vecOrigin, const Vec3D& angView, int nDepthMode) = 0;
    ...
    virtual void      DrawBrushModelEx(Entity* pEntity, Model* pModel, const Vec3D& vecOrigin, const Vec3D& angView, int nMode) = 0;
