...
bool ImGui::Hotkey(const char* label, int* k, const ImVec2& size_arg)
{
    ...
    ImGui::RenderTextClipped(frame_bb.Min + style.FramePadding + (width / 2), frame_bb.Max - style.FramePadding, buf_display, NULL, NULL, style.ButtonTextAlign, &clip_rect);
