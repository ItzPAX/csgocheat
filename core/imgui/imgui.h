...
struct ImVec2
{
    ...
    ImVec2 operator- (ImVec2 b) {
        return ImVec2(this->x - b.x, this->y - b.y);
    }
    ImVec2 operator* (float s) {
        return ImVec2(this->x * s, this->y * s);
    }
    ImVec2 operator+ (ImVec2 b) {
        return ImVec2(this->x + b.x, this->y + b.y);
    }
...
namespace ImGui
{
    ...
    IMGUI_API void          HelpMarker(const char* text);
